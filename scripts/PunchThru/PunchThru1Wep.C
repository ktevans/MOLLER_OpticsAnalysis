...
void PunchThru()
{
  ...
  T->Add("rootfilesPT/WSieveC12_ep_100k_1mm0.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_1mm1.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_1mm2.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_1mm3.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_1mm4.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_1mm5.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_1mm6.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_1mm7.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_1mm8.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_1mm9.root");
  ...
  TH2F *us_sieve_virt = new TH2F("us_sieve_virt","Upstream Sieve (1mm) Virtual Detector Electron and Positron Hits for ep Scattering with Thin Carbon Target", 7000, -150, 150, 7000, -150, 150);
  us_sieve_virt -> GetXaxis() -> SetTitle("x Position of Hits [mm]");
  us_sieve_virt -> GetYaxis() -> SetTitle("y Position of Hits [mm]");

  TH2F *ds_sieve_virt = new TH2F("ds_sieve_virt","Downstream Sieve (1mm) Virtual Detector Electron and Positron Hits for ep Scattering with Thin Carbon Target", 7000, -150, 150, 7000, -150, 150);
  ds_sieve_virt -> GetXaxis() -> SetTitle("x Position of Hits [mm]");
  ds_sieve_virt -> GetYaxis() -> SetTitle("y Position of Hits [mm]");

  TH2F *punch_thru_main = new TH2F("punch_thru_main","Electrons and Positrons that Punched Through the Sieve (1mm) and Hit the Main Detector for ep Scattering with Thin Carbon Target", 1000, -1200, 1200, 1000, -1200, 1200);
  punch_thru_main -> GetXaxis() -> SetTitle("x Position of Hits [mm]");
  punch_thru_main -> GetYaxis() -> SetTitle("y Position of Hits [mm]");

  TH2F *part_energy = new TH2F("part_energy","Electron and Positron Energies that Punched Through the Sieve (1mm) for ep Scattering with Thin Carbon Target", 1000, 0, 500, 1000, 0, 150);
  ...
  TH1F *radial_main = new TH1F("radial_main","Electrons and Positrons that Punch Through the Sieve (1mm) and Hit the Main Detector", 1000, 650, 1200);
...
//--------------------------------------------------------------------------------
  ...
  virt -> SaveAs("images/PT/Punch_Thru_US_DS_WSieve_1.png");
