...
//----------------------------------------------------------------------------
  ...
  TH2F *punch_thru_main_all = new TH2F("punch_thru_main_all","Electrons and Positrons that Punched Through the Sieve (110mm) and Hit the Main Detector for ep Scattering with Thin Carbon Target", 1000, -1200, 1200, 1000, -1200, 1200);
  ...
  TH1F *radial_main_all = new TH1F("radial_main_all","Particles that Punch Through the Sieve (110mm) and Hit the Main Detector", 1000, 650, 1200);
...
//Draw and save the histograms
  ...
  //Save the canvas as an image in the director "remoll/images/PT/"
  main_all -> SaveAs("images/PT/Punch_Thru_Main_All_WSieve_110.png");
