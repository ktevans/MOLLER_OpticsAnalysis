...
//residual_plots(0.17445783, 0.0, -0.000352099262, -0.0247428059, 0.00000025813027, -0.0014249449, 6.57310773, "11", "opticsAnalysis/opticsMatrix/output/output/sieveHole_p3_11.csv")

void residual_plots(double a_fit, double b0_fit, double b1_fit, double b2_fit, double b3_fit, double b4_fit, double b5_fit, const TString& hole_id, const char *datafile)
{
...
//------------------------------------------------------------------------------
  ...
  auto oned_residuals_tgraph = df_with_resid.Histo1D("residuals_th");
...
//------------------------------------------------------------------------------
  ...
  graphC->SaveAs("opticsAnalysis/opticsMatrix/ResidualPlots/tg_th_vs_gem1_r_p3_"+hole_id+".pdf");
  ...
  gPad -> Modified();
  gPad -> Update();
  resid_can -> SaveAs("opticsAnalysis/opticsMatrix/ResidualPlots/residuals_th_vs_gem1_r_p3_"+hole_id+".pdf");
  ...
  gPad -> Modified();
  gPad -> Update();
  TPaveLabel *Plab1 = new TPaveLabel(0.2, 0.95, 0.8, 1.0, "Residuals for Target Theta", "NDC");
  Plab1 -> Draw();
  gPad -> Modified();
  gPad-> Update();

  canvas_oned_resid -> SaveAs("opticsAnalysis/opticsMatrix/ResidualPlots/1d_residuals_th_p3_"+hole_id+".pdf");
