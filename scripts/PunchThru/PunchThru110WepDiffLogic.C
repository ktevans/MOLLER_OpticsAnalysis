...
void PunchThru()
{
  ...
  TH2F *punch_thru_main = new TH2F("punch_thru_main","Electrons and Positrons that Punched Through the Sieve (110mm) and Hit the Main Detector for ep Scattering with Thin Carbon Target", 1000, -1000, 1000, 1000, -1000, 1000);
  ...
  TH1F *radial_main = new TH1F("radial_main","Electrons and Positrons that Punch Through the Sieve (110mm) and Hit the Main Detector", 1000, 500, 1300);
...
//--------------------------------------------------------------------------------
  ...
  virt -> SaveAs("images/PT/Punch_Thru_US_DS_WSieve_110_difflogic.png");
  ...
  main -> SaveAs("images/PT/Punch_Thru_Main_WSieve_110_difflogic.png");

  TCanvas *energy = new TCanvas("energy","Electron and Positron Energies that Punch Through the Sieve", 400, 400, 600, 600);

  part_energy -> Draw();
  energy -> SaveAs("images/PT/Punch_Thru_Energy_WSieve_110_difflogic.png");
