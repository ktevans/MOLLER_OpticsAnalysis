...
TH2F *det28_prim_xy = new TH2F("det28_prim_xy","Detector 28 primary electron hits x vs y ",40,-1400,1400,40,-1400,1400);
det28_prim_xy -> GetXaxis() -> SetTitle("x position of hits [mm]");
det28_prim_xy -> GetYaxis() -> SetTitle("y position of hits [mm]");

TH2F* main_hole1 = new TH2F("main_hole1", "Detector 28 Primary Hit With Hole 1", 1000,-1400,1400,1000,-1400,1400);
main_hole1->GetXaxis()->SetTitle("Position in X");
main_hole1->GetYaxis()->SetTitle("Position in Y");
main_hole1->SetMarkerColor(kBlue);

TH2F* main_hole2 = new TH2F("main_hole2", "Detector 28 Primary Hit With Hole 2", 1000,-1400,1400,1000,-1400,1400);
main_hole2->GetXaxis()->SetTitle("Position in X");
main_hole2->GetYaxis()->SetTitle("Position in Y");
main_hole2->SetMarkerColor(kRed);

TH2F* main_hole3 = new TH2F("main_hole3", "Detector 28 Primary Hit With Hole 3", 1000,-1400,1400,1000,-1400,1400);
...
//----------------------------------------------------------------------
  ...
  //Now, you can place each stat box where you want it. Here I am just moving them in the Y direction, but you could make them wider too. The histogram is plotted between (0.1,0.1) and (0.9,0.9) in NDC. (0,0) is the bottom left of the canvas, and (1,1) is the top right.
