...
//Define Histograms that we will fill later
  ...
  TH1F *radial_main_holes = new TH1F("radial_main_holes","Particles that Pass Through the Sieve Holes (70mm) and Hit the Main Detector", 1000, 650, 1200);
...
//Draw and save the histograms
  ...
  //Save the canvas as an image in the director "remoll/images/PT/"
  main_all -> SaveAs("images/PT/Punch_Thru_Main_Holes_WSieve_70.png");
