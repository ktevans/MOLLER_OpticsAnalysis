...
void PunchThru()
{
  ...
  T->Add("rootfiles/sieveLH_moller_100k_60mm_W.root");
  T->Add("rootfiles/sieveLH_moller_100k_60mm_W1.root");
  T->Add("rootfiles/sieveLH_moller_100k_60mm_W2.root");
  T->Add("rootfiles/sieveLH_moller_100k_60mm_W3.root");
  T->Add("rootfiles/sieveLH_moller_100k_60mm_W4.root");
  T->Add("rootfiles/sieveLH_moller_100k_60mm_W5.root");
  T->Add("rootfiles/sieveLH_moller_100k_60mm_W6.root");
  T->Add("rootfiles/sieveLH_moller_100k_60mm_W7.root");
  T->Add("rootfiles/sieveLH_moller_100k_60mm_W8.root");
  T->Add("rootfiles/sieveLH_moller_100k_60mm_W9.root");
  ...
  TH2F *us_sieve_virt = new TH2F("us_sieve_virt","Upstream Sieve (60mm) Virtual Detector Electron and Positron Hits for Moller Scattering with Long Hydrogen Target", 7000, -150, 150, 7000, -150, 150);
  us_sieve_virt -> GetXaxis() -> SetTitle("x Position of Hits [mm]");
  us_sieve_virt -> GetYaxis() -> SetTitle("y Position of Hits [mm]");

  TH2F *ds_sieve_virt = new TH2F("ds_sieve_virt","Downstream Sieve (60mm) Virtual Detector Electron and Positron Hits for Moller Scattering with Long Hydrogen Target", 7000, -150, 150, 7000, -150, 150);
  ds_sieve_virt -> GetXaxis() -> SetTitle("x Position of Hits [mm]");
  ds_sieve_virt -> GetYaxis() -> SetTitle("y Position of Hits [mm]");

  TH2F *punch_thru_main = new TH2F("punch_thru_main","Electrons and Positrons that Punched Through the Sieve (60mm) and Hit the Main Detector for Moller Scattering with Long Hydrogen Target", 1000, -1000, 1000, 1000, -1000, 1000);
  punch_thru_main -> GetXaxis() -> SetTitle("x Position of Hits [mm]");
  punch_thru_main -> GetYaxis() -> SetTitle("y Position of Hits [mm]");

  TH2F *part_energy = new TH2F("part_energy","Electron and Positron Energies that Punched Through the Sieve (60mm) for Moller Scattering with Long Hydrogen Target", 1000, 0, 500, 1000, 0, 150);
  ...
  part_energy -> GetYaxis() -> SetTitle("Radial Position of Punch Through Hits [mm]");
    ...
    TH1F *radial_main = new TH1F("radial_main","Electrons and Positrons that Punch Through the Sieve (60mm) and Hit the Main Detector",1000,500,1300);
  radial_main -> GetXaxis() -> SetTitle("r Position of Hits [mm]");

  //TH2F *col2 = new TH2F("col2","Electrons and Positrons that Punch Through the Sieve (60mm) and Make it Past Collimator 2 for ep Scattering with C12 Target", 1000, -200, 200, 1000, -200, 200);
...
//--------------------------------------------------------------------------------
  ...
  virt -> SaveAs("images/Punch_Thru_US_DS_Sieve_moller_60.png");
