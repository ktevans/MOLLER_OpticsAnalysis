...
void NewDetailedSieve12HoleAnalysisRing2x()
{
...
//---Define Histograms---
  ...
  TH1F *radial_clean_pass = new TH1F("radial_clean_pass","Charged Particles that Pass Through Any of the Sieve (100mm) Holes (12mm Diameter) and Hit the Main Detector", 1000, 710, 760);
  ...
  TH1F *radial_hole_shower = new TH1F("radial_hole_shower","Charged Particles that Result from Primaries Hitting a Sieve Hole (12mm Diameter) and then Showering Through Sieve (100mm) and Hit the Main Detector", 1000, 710, 760);
  ...
  TH1F *radial_hit_shower = new TH1F("radial_hit_shower","Charged Particles that Result from Primaries Hitting the Sieve Surface and then Showering into a Sieve (100mm) Hole (12mm Diameter) and Hit the Main Detector", 1000, 710, 760);
...
//---Separate the Histograms---
  ...
  separate -> SaveAs("images/HA/Only_CP_12Hole_Analysis_Sieve_100_Ring2.png");
