...
//------------------------------------------------------------------------------
  ...
  auto pred_tgraph = df_with_resid.Graph("gem1_rp","tg_th_pred");
  ...
  auto true_tgraph = df_with_resid.Graph("gem1_rp","tg_th");
  ...
  auto residuals_tgraph = df_with_resid.Graph("gem1_rp","residuals_th");
...
//------------------------------------------------------------------------------
  ...
  multigraphC -> SetTitle("True (red) and predected (blue) values for target theta vs GEM1 radius prime");
  ...
  graphC->SaveAs("opticsAnalysis/opticsMatrix/ResidualPlots/theta/tg_th_vs_gem1_rp_"+trgt+"_"+pass+"_"+hole_id+".pdf");
  ...
  gPad -> Modified();
  gPad -> Update();
  resid_can -> SaveAs("opticsAnalysis/opticsMatrix/ResidualPlots/theta/residuals_th_vs_gem1_rp_"+trgt+"_"+pass+"_"+hole_id+".pdf");
