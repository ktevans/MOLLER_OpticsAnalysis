...
//  T->Add("rootfilesPT/BWSieveC12_ep_100k_105mm8.root");
  ...
  T->Add("rootfilesPT/BWSieveC12_ep_100k_105mm10.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_105mm11.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_105mm12.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_105mm13.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_105mm14.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_105mm15.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_105mm16.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_105mm17.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_105mm18.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_105mm19.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_105mm20.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_105mm21.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_105mm22.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_105mm23.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_105mm24.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_105mm25.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_105mm26.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_105mm27.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_105mm28.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_105mm29.root");
...
//Define Histograms that we will fill later
  ...
  TH2F *us_sieve_virt = new TH2F("us_sieve_virt","Upstream Sieve (105mm) Virtual Detector Electron and Positron Hits for ep Scattering with Thin Carbon Target", 7000, -150, 150, 7000, -150, 150);
  ...
  TH2F *ds_sieve_virt = new TH2F("ds_sieve_virt","Downstream Sieve (105mm) Virtual Detector Electron and Positron Hits for ep Scattering with Thin Carbon Target", 7000, -150, 150, 7000, -150, 150);
  ...
  TH2F *punch_thru_main = new TH2F("punch_thru_main","Electrons and Positrons that Punched Through the Sieve (105mm) and Hit the Main Detector for ep Scattering with Thin Carbon Target", 1000, -1200, 1200, 1000, -1200, 1200);
  ...
  TH1F *radial_main = new TH1F("radial_main","Electrons and Positrons that Punch Through the Sieve (105mm) and Hit the Main Detector", 1000, 650, 1200);
  ...
  TH2F *main_holes = new TH2F("main_holes","Electrons and Positrons that Pass Through the Sieve Holes (105mm) and Hit the Main Detector for ep Scattering with Thin Carbon Target", 1000, -1200, 1200, 1000, -1200, 1200);
  ...
  TH1F *radial_main_holes = new TH1F("radial_main_holes","Particles that Pass Through the Sieve Holes (105mm) and Hit the Main Detector", 1000, 650, 1200);
  ...
  TH2F *part_energy = new TH2F("part_energy","Electron and Positron Energies that Punched Through the Sieve (105mm) for ep Scattering with Thin Carbon Target", 1000, 0, 500, 1000, 0, 150);
  ...
  TH2F *part_high_energy = new TH2F("part_high_energy","Electron and Positron Energies that Punched Through the Sieve (105mm) for ep Scattering with Thin Carbon Target", 1000, 500, 1500, 1000, 0, 150);
...
//Draw and save the histograms
  ...
  virt -> SaveAs("images/PT/Punch_Thru_US_DS_WSieve_105.png");
  ...
  //Save the canvas as an image in the director "remoll/images/PT/"
  main -> SaveAs("images/PT/Punch_Thru_Main_WSieve_105.png");
  ...
  //Save the canvas as an image in the director "remoll/images/PT/"
  main_all -> SaveAs("images/PT/Punch_Thru_Main_Holes_WSieve_105.png");
  ...
  //Save the canvas as an image in the director "remoll/images/PT/"
  energy -> SaveAs("images/PT/Punch_Thru_Energy_WSieve_105.png");
