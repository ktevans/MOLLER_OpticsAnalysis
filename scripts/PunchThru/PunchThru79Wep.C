...
void PunchThru()
{
  ...
  T->Add("rootfilesPT/WSieveC12_ep_100k_79mm0.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_79mm1.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_79mm2.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_79mm3.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_79mm4.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_79mm5.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_79mm6.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_79mm7.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_79mm8.root");
//  T->Add("rootfilesPT/WSieveC12_ep_100k_79mm9.root");
...
//--------------------------------------------------------------------------------
  ...
  virt -> SaveAs("images/PT/Punch_Thru_US_DS_WSieve_79.png");
