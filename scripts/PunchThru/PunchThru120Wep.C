...
//----------------------------------------------------------------------------
  ...
  TH2F *us_sieve_virt = new TH2F("us_sieve_virt","Upstream Sieve (120mm) Virtual Detector Electron and Positron Hits for ep Scattering with Thin Carbon Target", 7000, -150, 150, 7000, -150, 150);
  ...
  TH2F *ds_sieve_virt = new TH2F("ds_sieve_virt","Downstream Sieve (120mm) Virtual Detector Electron and Positron Hits for ep Scattering with Thin Carbon Target", 7000, -150, 150, 7000, -150, 150);
  ...
  TH2F *punch_thru_main = new TH2F("punch_thru_main","Electrons and Positrons that Punched Through the Sieve (120mm) and Hit the Main Detector for ep Scattering with Thin Carbon Target", 1000, -1200, 1200, 1000, -1200, 1200);
  ...
  TH1F *radial_main = new TH1F("radial_main","Electrons and Positrons that Punch Through the Sieve (120mm) and Hit the Main Detector", 1000, 650, 1200);
  radial_main -> GetXaxis() -> SetTitle("r Position of Hits [mm]");

  //2D histogram for particles that punch through the sieve and make it to the main detector on the rings (xy plot)
  TH2F *punch_thru_main_all = new TH2F("punch_thru_main_all","Electrons and Positrons that Punched Through the Sieve (120mm) and Hit the Main Detector for ep Scattering with Thin Carbon Target", 1000, -1200, 1200, 1000, -1200, 1200);
  punch_thru_main_all -> GetXaxis() -> SetTitle("x Position of Hits [mm]");
  punch_thru_main_all -> GetYaxis() -> SetTitle("y Position of Hits [mm]");

  //1D histogram for particles that punch through the sieve and make it to the main detector on the rings (r plot)
  TH1F *radial_main_all = new TH1F("radial_main_all","Particles that Punch Through the Sieve (120mm) and Hit the Main Detector", 1000, 650, 1200);
  radial_main_all -> GetXaxis() -> SetTitle("r Position of Hits [mm]");

  //2D histogram of energies of punch through e+ and e- (0-500 MeV)
  TH2F *part_energy = new TH2F("part_energy","Electron and Positron Energies that Punched Through the Sieve (120mm) for ep Scattering with Thin Carbon Target", 1000, 0, 500, 1000, 0, 150);
  ...
  TH2F *part_high_energy = new TH2F("part_high_energy","Electron and Positron Energies that Punched Through the Sieve (120mm) for ep Scattering with Thin Carbon Target", 1000, 500, 1500, 1000, 0, 150);
  ...
  for (size_t iev = 0; iev < T->GetEntries(); iev++)
  {
    ...
    for (size_t ihit = 0; ihit < hits->size(); ihit++)
    {
      remollGenericDetectorHit_t hit = hits->at(ihit);
        ...
        if (punch_thru && hit.det==28 && hit.r>=650 && hit.r<=1200 && hit.pz>=0)
        {
          punch_thru_main_all -> Fill(hit.x, hit.y, rate);
...
//Draw and save the histograms
  ...
  virt -> SaveAs("images/PT/Punch_Thru_US_DS_WSieve_120.png");
  ...
  //Save the canvas as an image in the director "remoll/images/PT/"
  main -> SaveAs("images/PT/Punch_Thru_Main_WSieve_120.png");


  //---Main Detector---

  //Create a canvas on which to draw the histograms
  TCanvas *main_all = new TCanvas("main","Particles Hitting the Main Detector", 1000, 1000, 1000, 1000);
  ...
  //Save the canvas as an image in the director "remoll/images/PT/"
  main_all -> SaveAs("images/PT/Punch_Thru_Main_All_WSieve_120.png");
  ...
  //Save the canvas as an image in the director "remoll/images/PT/"
  energy -> SaveAs("images/PT/Punch_Thru_Energy_WSieve_120.png");
