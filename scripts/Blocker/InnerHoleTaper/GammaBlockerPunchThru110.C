...
//Draw and save the histograms
  ...
  virt -> SaveAs("images/Blocker/Taper/Gamma_Punch_Thru_US_DS_WBlocker_110.png");
  ...
  //Save the canvas as an image in the director "remoll/images/Blocker/"
  main -> SaveAs("images/Blocker/Taper/Gamma_Punch_Thru_Main_WBlocker_110.png");
  ...
  //Save the canvas as an image in the director "remoll/images/Blocker/"
  main_all_charged -> SaveAs("images/Blocker/Taper/Gamma_Main_All_WBlocker_110.png");
