...
#include <TF1.h>
void ElasticPrimaryAnalysis100mm14()
{
  ...
  T->Add("rootfiles/PrimAnalysis/ep_test_100k_100mm14.root");
...
//Draw and save the histograms
  ...
  main -> SaveAs("images/PrimAnalysis/ep_prim_main_WSieve_100_14.png");

  TCanvas *us = new TCanvas("us","Particles Hitting the Upstream Detector", 1000, 1000, 1000, 1000);

  prim_us -> Draw();

  us -> SaveAs("images/PrimAnalysis/ep_prim_us_WSieve_100_14.png");

  TCanvas *ds = new TCanvas("ds","Particles Hitting the Downstream Detector", 1000, 1000, 1000, 1000);

  prim_ds -> Draw();

  ds -> SaveAs("images/PrimAnalysis/ep_prim_ds_WSieve_100_14.png");
