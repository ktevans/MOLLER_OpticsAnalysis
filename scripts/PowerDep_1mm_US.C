...
void PowerDep()
{
  ...
  T->Add("rootfilesPT/blocker_beamC12_US_1mm_0.root");
  T->Add("rootfilesPT/blocker_beamC12_US_1mm_1.root");
  T->Add("rootfilesPT/blocker_beamC12_US_1mm_2.root");
  T->Add("rootfilesPT/blocker_beamC12_US_1mm_3.root");
  T->Add("rootfilesPT/blocker_beamC12_US_1mm_4.root");
  T->Add("rootfilesPT/blocker_beamC12_US_1mm_5.root");
  T->Add("rootfilesPT/blocker_beamC12_US_1mm_6.root");
  T->Add("rootfilesPT/blocker_beamC12_US_1mm_7.root");
  T->Add("rootfilesPT/blocker_beamC12_US_1mm_8.root");
  T->Add("rootfilesPT/blocker_beamC12_US_1mm_9.root");
  T->Add("rootfilesPT/blocker_beamC12_US_1mm_10.root");
  T->Add("rootfilesPT/blocker_beamC12_US_1mm_11.root");
  T->Add("rootfilesPT/blocker_beamC12_US_1mm_12.root");
  T->Add("rootfilesPT/blocker_beamC12_US_1mm_13.root");
  T->Add("rootfilesPT/blocker_beamC12_US_1mm_14.root");
  T->Add("rootfilesPT/blocker_beamC12_US_1mm_15.root");
  T->Add("rootfilesPT/blocker_beamC12_US_1mm_16.root");
  T->Add("rootfilesPT/blocker_beamC12_US_1mm_17.root");
  T->Add("rootfilesPT/blocker_beamC12_US_1mm_18.root");
  T->Add("rootfilesPT/blocker_beamC12_US_1mm_19.root");
...
//----------------------------------------------------------------------------
  ...
  TH1F *edep_blocker = new TH1F("edep_blocker","Sum of Energy Deposition on the Blocker for a 90mm Blocker with 1mm Inner Bore Radius and an Upstream C12 Target", 100, 0, 11000);
...
//Draw and save the histograms
  ...
  blocker -> SaveAs("images/PowerDep_Det1000_All_90mmblocker_US_1mm.png");
