...
RNode GenMollerDF(RNode df){
   ...
   auto selected_df = df.Define("prm_e",primary_hit).Define("main","hit.det==28").Define("sieve","hit.det==270").Define("gem","hit.det==30")
	            .Define("gem_1","hit.det==32").Define("gem_2","hit.det==33")
		    .Define("gem_3","hit.det==34").Define("gem_4","hit.det==35")
