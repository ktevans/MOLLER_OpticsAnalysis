...
//----------------------------------------------------------------------------
  ...
  TH1F *radial_main_all = new TH1F("radial_main_all","Energies of All Primaries that Hit the Main Detector for a"+Thickness+" mm Blocker", 100, 0, 10000);
  ...
  TH2F *xy_main_all = new TH2F("xy_main_all","All Primaries that Hit the Main Detector for a "+Thickness+" mm Blocker", 100, -1200, 1200, 100, -1200, 1200);
  ...
  TH1F *vertex_main = new TH1F("vertex_main","Z Vertex of All Charged Particles that Hit the Main Detector for a "+Thickness+" mm Blocker", 100, -4500, 22000);
  ...
  TH1F *ring2_all = new TH1F("ring2_all","All Primaries that Hit Ring 2 on the Main Detector for a "+Thickness+" mm Blocker", 1000, 710, 760);
...
//Draw and save the histograms
  ...
  main_all_color -> SaveAs("images/Blocker/InnerHoleTaper/Prim_Main_All_Color_WBlocker_"+Thickness+".png");
  ...
  //Save the canvas as an image in the director "remoll/images/Blocker/"
  main_all -> SaveAs("images/Blocker/InnerHoleTaper/Prim_Main_All_WBlocker_"+Thickness+".png");
  ...
  //Save the canvas as an image in the director "remoll/images/Blocker/"
  main_all_vr -> SaveAs("images/Blocker/InnerHoleTaper/Prim_Main_All_VR_WBlocker_"+Thickness+".png");
