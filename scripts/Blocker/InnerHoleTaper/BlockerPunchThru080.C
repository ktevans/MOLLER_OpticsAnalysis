  ...
  for (size_t iev = 0; iev < T->GetEntries(); iev++)
  {
    ...
    for (size_t ihit = 0; ihit < hits->size(); ihit++)
    {
      ...
      if ((hit.pid==11 || hit.pid==-11) && hit.r<97.9932)
      {
          ...
          if (hit.det == 1004 && hit.pz >= 0 && hit.r >= 15.69)
          {
...
//Draw and save the histograms
  ...
  virt -> SaveAs("images/Blocker/Taper/CP_Punch_Thru_US_DS_WBlocker_080.png");
  ...
  //Save the canvas as an image in the director "remoll/images/Blocker/"
  main -> SaveAs("images/Blocker/Taper/CP_Punch_Thru_Main_WBlocker_080.png");
  ...
  //Save the canvas as an image in the director "remoll/images/Blocker/"
  main_all_charged -> SaveAs("images/Blocker/Taper/CP_Main_All_WBlocker_080.png");
