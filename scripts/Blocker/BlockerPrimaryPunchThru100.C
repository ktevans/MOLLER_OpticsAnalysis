...
#include <TF1.h>
void BlockerPrimaryPunchThru100()
{
  //Allow Tree to use the root files that you call
  TChain* T = new TChain("T");

  //Add files from the directory "rootfilesPT/", "100" is the Blocker thickness in mm
  T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_100mm0.root");
  T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_100mm1.root");
  T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_100mm2.root");
  T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_100mm3.root");
  T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_100mm4.root");
  T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_100mm5.root");
  T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_100mm6.root");
  T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_100mm7.root");
  T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_100mm8.root");
  T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_100mm9.root");
/*
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_100mm10.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_100mm11.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_100mm12.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_100mm13.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_100mm14.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_100mm15.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_100mm16.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_100mm17.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_100mm18.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_100mm19.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_100mm20.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_100mm21.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_100mm22.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_100mm23.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_100mm24.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_100mm25.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_100mm26.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_100mm27.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_100mm28.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_100mm29.root");
*/
...
//----------------------------------------------------------------------------
  ...
  TH2F *us_Blocker_virt = new TH2F("us_Blocker_virt","Upstream Blocker (100mm) Virtual Detector Primaries Hits for ep Scattering with Thin Carbon Target", 7000, -150, 150, 7000, -150, 150);
  ...
  TH2F *ds_Blocker_virt = new TH2F("ds_Blocker_virt","Downstream Blocker (100mm) Virtual Detector Primaries Hits for ep Scattering with Thin Carbon Target", 7000, -150, 150, 7000, -150, 150);
  ...
  TH2F *radial_main = new TH2F("radial_main","Energies of Primaries that Punch Through the Blocker (100mm) and Hit the Main Detector", 1000, 650, 1200, 3000, 0, 1500);
  ...
  TH2F *punch_thru_xy_main = new TH2F("punch_thru_xy_main","Primaries that Punched Through the Blocker (100mm) and Hit the Main Detector for ep Scattering with Thin Carbon Target", 1000, -1200, 1200, 1000, -1200, 1200);
  ...
  TH2F *radial_main_all = new TH2F("radial_main_all","Energies of All Primaries that Hit the Main Detector for a 100mm Blocker", 1000, 650, 1200, 3000, 0, 1500);
  ...
  TH2F *xy_main_all = new TH2F("xy_main_all","All Primaries that Hit the Main Detector for a 100mm Blocker", 1000, -1200, 1200, 1000, -1200, 1200);
...
//Draw and save the histograms
  ...
  virt -> SaveAs("images/Blocker/Primary_Punch_Thru_US_DS_WBlocker_100.png");
  ...
  //Save the canvas as an image in the director "remoll/images/Blocker/"
  main -> SaveAs("images/Blocker/Primary_Punch_Thru_Main_WBlocker_100.png");
  ...
  //Save the canvas as an image in the director "remoll/images/Blocker/"
  main_all_charged -> SaveAs("images/Blocker/Primary_Main_All_WBlocker_100.png");
