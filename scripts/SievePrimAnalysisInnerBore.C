...
//----------------------------------------------------------------------------
  ...
  TH1F *radial_main_all_color = new TH1F("radial_main_all_color","Radial Position of Primary Hits on the Main Detector Rings for a 90mm "+collimator+" with "+geo+" Geometry", 100, 650, 1200);
  radial_main_all_color -> GetXaxis() -> SetTitle("r Position of Hits [mm]");

  TH2F *xy_main_all_color = new TH2F("xy_main_all_color","Primary Hits on the Main Detector Rings for a 90mm "+collimator+" with "+geo+" Geometry", 100, -1200, 1200, 100, -1200, 1200);
  xy_main_all_color -> GetXaxis() -> SetTitle("x Position of Hits [mm]");
  xy_main_all_color -> GetYaxis() -> SetTitle("y Position of Hits [mm]");

  TH2F *xy_main_all = new TH2F("xy_main_all","Primary Hits on the Main Detector Rings for a 90mm "+collimator+" with "+geo+" Geometry", 1000, -1200, 1200, 1000, -1200, 1200);
  xy_main_all -> GetXaxis() -> SetTitle("x Position of Hits [mm]");
  xy_main_all -> GetYaxis() -> SetTitle("y Position of Hits [mm]");

  TH1F *vertex_main = new TH1F("vertex_main","Z Vertex of All Primaries that Hit the Main Detector for a 90mm "+collimator+" with "+geo+" Geometry", 100, -4500, 22000);
  vertex_main -> GetXaxis() -> SetTitle("z Position of the Vertex of Hits [mm]");

  TH1F *ring2_all = new TH1F("ring2_all","All Primaries that Hit Ring 2 on the Main Detector for a 90mm "+collimator+" with "+geo+" Geometry", 1000, 710, 760);
...
//Draw and save the histograms
  ...
  main_all_color -> SaveAs("images/InnerBore/Prim_Main_All_Color_90mm"+collimator+"_"+geo+".png");
  ...
  //Save the canvas as an image in the director "remoll/images/Blocker/"
  main_all -> SaveAs("images/InnerBore/Prim_Main_All_90mm"+collimator+"_"+geo+".png");
  ...
  //Save the canvas as an image in the director "remoll/images/Blocker/"
  main_all_vr -> SaveAs("images/InnerBore/Prim_Main_All_VR_90mm"+collimator+"_"+geo+".png");
