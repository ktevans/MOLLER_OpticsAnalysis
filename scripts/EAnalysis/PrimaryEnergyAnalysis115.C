...
//----------------------------------------------------------------------------
  ...
  TH1F *prim_pass = new TH1F("prim_pass","Primaries that Hit the Main Detector Rings with a W Sieve (115mm)", 1000, 650, 1200);
...
//Draw and save the histograms
  ...
  main_all -> SaveAs("images/EAnalysis/prim_main_WSieve_115.png");
