...
void PowerDep()
{
  ...
  T->Add("rootfilesPT/blocker_beamLH2_DS_g1_0_v2.root");
  T->Add("rootfilesPT/blocker_beamLH2_DS_g1_1_v2.root");
  T->Add("rootfilesPT/blocker_beamLH2_DS_g1_2_v2.root");
  T->Add("rootfilesPT/blocker_beamLH2_DS_g1_3_v2.root");
//  T->Add("rootfilesPT/blocker_beamLH2_DS_g1_4_v2.root");
  T->Add("rootfilesPT/blocker_beamLH2_DS_g1_5_v2.root");
  T->Add("rootfilesPT/blocker_beamLH2_DS_g1_6_v2.root");
  T->Add("rootfilesPT/blocker_beamLH2_DS_g1_7_v2.root");
  T->Add("rootfilesPT/blocker_beamLH2_DS_g1_8_v2.root");
//  T->Add("rootfilesPT/blocker_beamLH2_DS_g1_9_v2.root");
  T->Add("rootfilesPT/blocker_beamLH2_DS_g1_10_v2.root");
  T->Add("rootfilesPT/blocker_beamLH2_DS_g1_11_v2.root");
  T->Add("rootfilesPT/blocker_beamLH2_DS_g1_12_v2.root");
  T->Add("rootfilesPT/blocker_beamLH2_DS_g1_13_v2.root");
//  T->Add("rootfilesPT/blocker_beamLH2_DS_g1_14_v2.root");
  T->Add("rootfilesPT/blocker_beamLH2_DS_g1_15_v2.root");
  T->Add("rootfilesPT/blocker_beamLH2_DS_g1_16_v2.root");
  T->Add("rootfilesPT/blocker_beamLH2_DS_g1_17_v2.root");
  T->Add("rootfilesPT/blocker_beamLH2_DS_g1_18_v2.root");
//  T->Add("rootfilesPT/blocker_beamLH2_DS_g1_19_v2.root");
...
//----------------------------------------------------------------------------
  ...
  TH1F *edep_blocker = new TH1F("edep_blocker","Sum of Energy Deposition on the Blocker for a 90mm Blocker with 28.63mm Inner Bore Radius and an Downstream C12 Target", 100, 0, 11000);
...
//Draw and save the histograms
  ...
  blocker -> SaveAs("images/PowerDep_Det1000_All_90mmblocker_DS_g1_v2_LH2.png");
