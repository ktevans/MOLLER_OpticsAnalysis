...
void PunchThru(const TString& files)
{
  ...
  TH2F *us_sieve_virt = new TH2F("us_sieve_virt","Upstream Sieve (60mm) Virtual Detector Electron and Positron Hits for ep Scattering with C12 Target", 7000, -150, 150, 7000, -150, 150);
  ...
  TH2F *ds_sieve_virt = new TH2F("ds_sieve_virt","Downstream Sieve (60mm) Virtual Detector Electron and Positron Hits for ep Scattering with C12 Target", 7000, -150, 150, 7000, -150, 150);
  ...
  TH2F *punch_thru_main = new TH2F("punch_thru_main","Electrons and Positrons that Punched Through the Sieve (60mm) for ep Scattering with C12 Target", 1000, -300, 300, 1000, -300, 300);
  punch_thru_main -> GetXaxis() -> SetTitle("x Position of Hits [mm]");
  punch_thru_main -> GetYaxis() -> SetTitle("y Position of Hits [mm]");

  TH2F *part_energy = new TH2F("part_energy","Electron and Positron Energies that Punched Through the Sieve (60mm) for ep Scattering with C12 Target", 1000, 0, 500, 1000, 0, 150);
...
//--------------------------------------------------------------------------------
  ...
  virt -> SaveAs("images/Punch_Thru_US_DS_Sieve_60.png");
