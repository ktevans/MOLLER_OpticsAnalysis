...
//----------------------------------------------------------------------------
  ...
  TH2F *us_Blocker_virt = new TH2F("us_Blocker_virt","Upstream Blocker (040mm) Virtual Detector Gammas Hits for ep Scattering with Thin Carbon Target", 7000, -150, 150, 7000, -150, 150);
  ...
  TH2F *ds_Blocker_virt = new TH2F("ds_Blocker_virt","Downstream Blocker (040mm) Virtual Detector Gammas Hits for ep Scattering with Thin Carbon Target", 7000, -150, 150, 7000, -150, 150);
  ...
  TH2F *radial_main = new TH2F("radial_main","Energies of Gammas that Punch Through the Blocker (040mm) and Hit the Main Detector", 1000, 650, 1200, 3000, 0, 1500);
  ...
  TH2F *punch_thru_xy_main = new TH2F("punch_thru_xy_main","Gammas that Punched Through the Blocker (040mm) and Hit the Main Detector for ep Scattering with Thin Carbon Target", 1000, -1200, 1200, 1000, -1200, 1200);
  ...
  TH2F *radial_main_all = new TH2F("radial_main_all","Energies of All Gammas that Hit the Main Detector for a 040mm Blocker", 1000, 650, 1200, 3000, 0, 1500);
  ...
  TH2F *xy_main_all = new TH2F("xy_main_all","All Gammas that Hit the Main Detector for a 040mm Blocker", 1000, -1200, 1200, 1000, -1200, 1200);
...
//Draw and save the histograms
  ...
  virt -> SaveAs("images/Blocker/Gamma_Punch_Thru_US_DS_WBlocker_040.png");
  ...
  //Save the canvas as an image in the director "remoll/images/Blocker/"
  main -> SaveAs("images/Blocker/Gamma_Punch_Thru_Main_WBlocker_040.png");
  ...
  //Save the canvas as an image in the director "remoll/images/Blocker/"
  main_all_charged -> SaveAs("images/Blocker/Gamma_Main_All_WBlocker_040.png");
