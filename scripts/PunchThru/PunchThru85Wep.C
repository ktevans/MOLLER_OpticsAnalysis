...
void PunchThru()
{
  ...
  T->Add("rootfilesPT/WSieveC12_ep_100k_85mm0.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_85mm1.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_85mm2.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_85mm3.root");
//  T->Add("rootfilesPT/WSieveC12_ep_100k_85mm4.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_85mm5.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_85mm6.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_85mm7.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_85mm8.root");
//  T->Add("rootfilesPT/WSieveC12_ep_100k_85mm9.root");
