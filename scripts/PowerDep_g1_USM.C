...
void PowerDep()
{
  ...
  T->Add("rootfilesPT/blocker_beamC12_USM_g1_0.root");
  T->Add("rootfilesPT/blocker_beamC12_USM_g1_1.root");
  T->Add("rootfilesPT/blocker_beamC12_USM_g1_2.root");
  T->Add("rootfilesPT/blocker_beamC12_USM_g1_3.root");
  T->Add("rootfilesPT/blocker_beamC12_USM_g1_4.root");
...
//----------------------------------------------------------------------------
  ...
  TH1F *edep_blocker = new TH1F("edep_blocker","Sum of Energy Deposition on the Blocker for a 90mm Blocker with 28.63mm Inner Bore Radius and USM Target Positions", 100, 0, 11000);
...
//Draw and save the histograms
  ...
  blocker -> SaveAs("images/PowerDep_Det1000_All_90mmblocker_g1_USM.png");
