...
//----------------------------------------------------------------------------
  ...
  TH1F *radial_main = new TH1F("radial_main","Energies of Electrons and Positrons that Punch Through the Sieve (120mm) and Hit the Main Detector", 1000, 0, 600);
  radial_main -> GetXaxis() -> SetTitle("Energy of Hits [MeV]");
