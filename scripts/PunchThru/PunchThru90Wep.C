...
void PunchThru()
{
  ...
  //Add files from the directory "rootfilesPT/", "90" is the sieve thickness in mm
...
//----------------------------------------------------------------------------
  ...
  TH2F *punch_thru_main_all = new TH2F("punch_thru_main_all","Electrons and Positrons that Punched Through the Sieve (90mm) and Hit the Main Detector for ep Scattering with Thin Carbon Target", 1000, -1200, 1200, 1000, -1200, 1200);
  ...
  TH1F *radial_main_all = new TH1F("radial_main_all","Particles that Punch Through the Sieve (90mm) and Hit the Main Detector", 1000, 650, 1200);
  ...
  TH2F *part_high_energy = new TH2F("part_high_energy","Electron and Positron Energies that Punched Through the Sieve (90mm) for ep Scattering with Thin Carbon Target", 1000, 500, 1500, 1000, 0, 150);
...
//Draw and save the histograms
  ...
  virt -> SaveAs("images/PT/Punch_Thru_US_DS_WSieve_90.png");
  ...
  //Save the canvas as an image in the director "remoll/images/PT/"
  main -> SaveAs("images/PT/Punch_Thru_Main_WSieve_90.png");
  ...
  //Save the canvas as an image in the director "remoll/images/PT/"
  main_all -> SaveAs("images/PT/Punch_Thru_Main_All_WSieve_90.png");
  ...
  //Save the canvas as an image in the director "remoll/images/PT/"
  energy -> SaveAs("images/PT/Punch_Thru_Energy_WSieve_90.png");
