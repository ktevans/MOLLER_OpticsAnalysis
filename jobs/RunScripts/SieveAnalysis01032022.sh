...
echo 'gROOT->LoadMacro("scripts/SieveInnerHoleAnalysisRadDose12162021.C"); Analysis("blocker","g1"); gSystem->Exit(0);' | build/reroot -b -l
echo 'gROOT->LoadMacro("scripts/SieveInnerHoleAnalysisRadDose12162021.C"); Analysis("blocker","g2"); gSystem->Exit(0);' | build/reroot -b -l
