...
void DetailedSieve06HoleAnalysisRing2()
{
...
//----------------------------------------------------------------------------
  ...
  for (size_t iev = 0; iev < T->GetEntries(); iev++)
  {
    ...
    for (size_t ihit = 0; ihit < hits->size(); ihit++)
    {
      ...
      if((hit.trid == 1 || hit.trid == 2 || hit.pid == 11 || hit.pid == -11) && hit.pz >= 0 && hit.det == 28 && hit.r>=710 && hit.r<=760)
      {
...
//---Separate the Histograms---
  ...
  separate -> SaveAs("images/HA/CP_06Hole_Analysis_Sieve_100_Separate_Ring2.png");
