...
#include <TF1.h>
void ElectronsMain_taper_03_min_Ring2()
{
  ...
  TH1F* h28 = new TH1F("h28","Electron Hits on the Main Detector Rings",500,710,760);
  ...
  for (size_t iev = 0; iev < T->GetEntries(); iev++)
  {
    ...
    for (size_t ihit = 0; ihit < hits->size(); ihit++)
    {
      ...
      if (hit.det==28 && hit.pid==11 && hit.r>=710 && hit.r<=760)
      {
         h28->Fill(hit.r);
      } // end if statement
  ...
  c1->SaveAs("images/electrons_main_03_min_taper_Ring2.png");
}
