...
//Define Histograms that we will fill later
  ...
  TH1F *radial_main = new TH1F("radial_main","Electrons and Positrons that Punch Through the Sieve (120mm) and Hit the Main Detector", 1000, 680, 750);
  ...
  TH2F *main_holes = new TH2F("main_holes","Electrons and Positrons that Pass Through the Sieve Holes (120mm) and Hit the Main Detector for ep Scattering with Thin Carbon Target", 1000, -1200, 1200, 1000, -1200, 1200);
  ...
  TH1F *radial_main_holes = new TH1F("radial_main_holes","Particles that Pass Through the Sieve Holes (120mm) and Hit the Main Detector", 1000, 680, 750);
...
//Draw and save the histograms
  ...
  //Save the canvas as an image in the director "remoll/images/PT/"
  main -> SaveAs("images/PT/Zoom_Punch_Thru_Main_WSieve_120.png");
  ...
  //Save the canvas as an image in the director "remoll/images/PT/"
  main_all -> SaveAs("images/PT/Zoom_Punch_Thru_Main_Holes_WSieve_120.png");
