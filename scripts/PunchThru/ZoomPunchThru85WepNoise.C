...
#include <TF1.h>
void ZoomPunchThru85WepNoise()
{
  //Allow Tree to use the root files that you call
  TChain* T = new TChain("T");
  
  //Add files from the directory "rootfilesPT/", "85" is the sieve thickness in mm
  T->Add("rootfilesPT/BWSieveC12_ep_100k_85mm0.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_85mm1.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_85mm2.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_85mm3.root");
//  T->Add("rootfilesPT/BWSieveC12_ep_100k_85mm4.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_85mm5.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_85mm6.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_85mm7.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_85mm8.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_85mm9.root");
...
//Define Histograms that we will fill later
  ...
  TH2F *us_sieve_virt = new TH2F("us_sieve_virt","Upstream Sieve (85mm) Virtual Detector Electron and Positron Hits for ep Scattering with Thin Carbon Target", 7000, -150, 150, 7000, -150, 150);
  ...
  TH2F *ds_sieve_virt = new TH2F("ds_sieve_virt","Downstream Sieve (85mm) Virtual Detector Electron and Positron Hits for ep Scattering with Thin Carbon Target", 7000, -150, 150, 7000, -150, 150);
  ...
  TH2F *punch_thru_main = new TH2F("punch_thru_main","Electrons and Positrons that Punched Through the Sieve (85mm) and Hit the Main Detector for ep Scattering with Thin Carbon Target", 1000, -1200, 1200, 1000, -1200, 1200);
  ...
  TH1F *radial_main = new TH1F("radial_main","Electrons and Positrons that Punch Through the Sieve (85mm) and Hit the Main Detector", 1000, 680, 750);
  ...
  TH2F *main_holes = new TH2F("main_holes","Electrons and Positrons that Pass Through the Sieve Holes (85mm) and Hit the Main Detector for ep Scattering with Thin Carbon Target", 1000, -1200, 1200, 1000, -1200, 1200);
  ...
  TH1F *radial_main_holes = new TH1F("radial_main_holes","Particles that Pass Through the Sieve Holes (85mm) and Hit the Main Detector", 1000, 680, 750);
  ...
  TH2F *part_energy = new TH2F("part_energy","Electron and Positron Energies that Punched Through the Sieve (85mm) for ep Scattering with Thin Carbon Target", 1000, 0, 500, 1000, 0, 150);
  ...
  TH2F *part_high_energy = new TH2F("part_high_energy","Electron and Positron Energies that Punched Through the Sieve (85mm) for ep Scattering with Thin Carbon Target", 1000, 500, 1500, 1000, 0, 150);
...
//Draw and save the histograms
  ...
  virt -> SaveAs("images/PT/Punch_Thru_US_DS_WSieve_85.png");
  ...
  //Save the canvas as an image in the director "remoll/images/PT/"
  main -> SaveAs("images/PT/Zoom_Punch_Thru_Main_WSieve_85.png");
  ...
  //Save the canvas as an image in the director "remoll/images/PT/"
  main_all -> SaveAs("images/PT/Zoom_Punch_Thru_Main_Holes_WSieve_85.png");
  ...
  //Save the canvas as an image in the director "remoll/images/PT/"
  energy -> SaveAs("images/PT/Punch_Thru_Energy_WSieve_85.png");
