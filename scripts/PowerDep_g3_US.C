...
void PowerDep()
{
  ...
  T->Add("rootfilesPT/blocker_beamC12_US_g3_0.root");
  T->Add("rootfilesPT/blocker_beamC12_US_g3_1.root");
  T->Add("rootfilesPT/blocker_beamC12_US_g3_2.root");
  T->Add("rootfilesPT/blocker_beamC12_US_g3_3.root");
  T->Add("rootfilesPT/blocker_beamC12_US_g3_4.root");
  T->Add("rootfilesPT/blocker_beamC12_US_g3_5.root");
  T->Add("rootfilesPT/blocker_beamC12_US_g3_6.root");
  T->Add("rootfilesPT/blocker_beamC12_US_g3_7.root");
  T->Add("rootfilesPT/blocker_beamC12_US_g3_8.root");
  T->Add("rootfilesPT/blocker_beamC12_US_g3_9.root");
  T->Add("rootfilesPT/blocker_beamC12_US_g3_10.root");
  T->Add("rootfilesPT/blocker_beamC12_US_g3_11.root");
  T->Add("rootfilesPT/blocker_beamC12_US_g3_12.root");
  T->Add("rootfilesPT/blocker_beamC12_US_g3_13.root");
  T->Add("rootfilesPT/blocker_beamC12_US_g3_14.root");
  T->Add("rootfilesPT/blocker_beamC12_US_g3_15.root");
  T->Add("rootfilesPT/blocker_beamC12_US_g3_16.root");
  T->Add("rootfilesPT/blocker_beamC12_US_g3_17.root");
  T->Add("rootfilesPT/blocker_beamC12_US_g3_18.root");
  T->Add("rootfilesPT/blocker_beamC12_US_g3_19.root");
...
//----------------------------------------------------------------------------
  ...
  TH1F *edep_blocker = new TH1F("edep_blocker","Sum of Energy Deposition on the Blocker for a 90mm Blocker with 26mm Inner Bore Radius and an Upstream C12 Target", 100, 0, 11000);
...
//Draw and save the histograms
  ...
  blocker -> SaveAs("images/PowerDep_Det1000_All_90mmblocker_US_g3.png");
