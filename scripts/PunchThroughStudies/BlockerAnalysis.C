...
//  echo 'gROOT->LoadMacro("BlockerPunchThru.C"); Blocker("100"); gSystem->Exit(0);' | build/reroot -b -l 
//
...
//----------------------------------------------------------------------------
  ...
  TH1F *radial_main_all = new TH1F("radial_main_all","Energies of All Charged Particles that Hit the Main Detector for a"+Thickness+" mm Blocker", 500, 0, 10000);
  ...
  TH2F *xy_main_all = new TH2F("xy_main_all","All Charged Particles that Hit the Main Detector for a "+Thickness+" mm Blocker", 1000, -1200, 1200, 1000, -1200, 1200);
  xy_main_all -> GetXaxis() -> SetTitle("x Position of Hits [mm]");
  xy_main_all -> GetYaxis() -> SetTitle("y Position of Hits [mm]");

  //2D histogram for z vertices of particles that make it to the main detector on the rings (xy plot)
  TH2F *vertex_main = new TH2F("vertex_main","Z Vertex of All Charged Particles that Hit the Main Detector for a "+Thickness+" mm Blocker", 5000, -4500, 22000, 1000, 650, 1200);
  vertex_main -> GetXaxis() -> SetTitle("z Position of the Vertex of Hits [mm]");
  vertex_main -> GetYaxis() -> SetTitle("r Position of Hits [mm]");
...
//Draw and save the histograms
  ...
  main_all_color -> SaveAs("images/Blocker/InnerHoleTaper/Main_All_Color_WBlocker_"+Thickness+".png");
  ...
  //Save the canvas as an image in the director "remoll/images/Blocker/"
  main_all -> SaveAs("images/Blocker/InnerHoleTaper/Main_All_WBlocker_"+Thickness+".png");
  ...
  //Save the canvas as an image in the director "remoll/images/Blocker/"
  main_all_vr -> SaveAs("images/Blocker/InnerHoleTaper/Main_All_VR_WBlocker_"+Thickness+".png");
