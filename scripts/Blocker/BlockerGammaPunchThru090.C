...
//----------------------------------------------------------------------------
  ...
  TH2F *us_Blocker_virt = new TH2F("us_Blocker_virt","Upstream Blocker (090mm) Virtual Detector Gammas Hits for ep Scattering with Thin Carbon Target", 7000, -150, 150, 7000, -150, 150);
  ...
  TH2F *ds_Blocker_virt = new TH2F("ds_Blocker_virt","Downstream Blocker (090mm) Virtual Detector Gammas Hits for ep Scattering with Thin Carbon Target", 7000, -150, 150, 7000, -150, 150);
  ...
  TH2F *radial_main = new TH2F("radial_main","Energies of Gammas that Punch Through the Blocker (090mm) and Hit the Main Detector", 1000, 650, 1200, 3000, 0, 1500);
  ...
  TH2F *punch_thru_xy_main = new TH2F("punch_thru_xy_main","Gammas that Punched Through the Blocker (090mm) and Hit the Main Detector for ep Scattering with Thin Carbon Target", 1000, -1200, 1200, 1000, -1200, 1200);
  ...
  TH2F *radial_main_all = new TH2F("radial_main_all","Energies of All Gammas that Hit the Main Detector for a 090mm Blocker", 1000, 650, 1200, 3000, 0, 1500);
  ...
  TH2F *xy_main_all = new TH2F("xy_main_all","All Gammas that Hit the Main Detector for a 090mm Blocker", 1000, -1200, 1200, 1000, -1200, 1200);
