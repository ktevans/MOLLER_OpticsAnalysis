...
void Blocker(const TString& Thickness, const double t)
{
  ...
  //----------------------------------------------------------------------------
    ...
    TH2F *US_surface = new TH2F("US_surface","All Gammas that Hit the Upstream Surface of a "+Thickness+" mm Tapered Blocker", 100, -120, 120, 100, -120, 120);
    ...
    TH2F *DS_surface = new TH2F("DS_surface","All Gammas that Hit the Downstream Surface of a "+Thickness+" mm Tapered Blocker", 100, -120, 120, 100, -120, 120);
...
virt -> SaveAs("images/Blocker/InnerHoleTaper/Gamma_US_DS_TWBlocker_"+Thickness+".png");
