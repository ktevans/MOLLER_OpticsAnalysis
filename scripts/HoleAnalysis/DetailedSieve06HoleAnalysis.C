...
void DetailedSieve06HoleAnalysis()
{
...
//---Set up Chain and Tree---
  ...
  T->Add("rootfilesHA/HD06_sieveC12_ep_100k_100mm0.root");
  T->Add("rootfilesHA/HD06_sieveC12_ep_100k_100mm1.root");
  T->Add("rootfilesHA/HD06_sieveC12_ep_100k_100mm2.root");
  T->Add("rootfilesHA/HD06_sieveC12_ep_100k_100mm3.root");
  T->Add("rootfilesHA/HD06_sieveC12_ep_100k_100mm4.root");
  T->Add("rootfilesHA/HD06_sieveC12_ep_100k_100mm5.root");
  T->Add("rootfilesHA/HD06_sieveC12_ep_100k_100mm6.root");
  T->Add("rootfilesHA/HD06_sieveC12_ep_100k_100mm7.root");
  T->Add("rootfilesHA/HD06_sieveC12_ep_100k_100mm8.root");
  T->Add("rootfilesHA/HD06_sieveC12_ep_100k_100mm9.root");
...
//---Define Histograms---
  ...
  TH1F *radial_clean_pass = new TH1F("radial_clean_pass","Charged Particles that Pass Through Any of the Sieve (100mm) Holes (06mm Diameter) and Hit the Main Detector", 1000, 650, 1200);
  ...
  TH1F *radial_hole_shower = new TH1F("radial_hole_shower","Charged Particles that Result from Primaries Hitting a Sieve Hole (06mm Diameter) and then Showering Through Sieve (100mm) and Hit the Main Detector", 1000, 650, 1200);
  ...
  TH1F *radial_hit_shower = new TH1F("radial_hit_shower","Charged Particles that Result from Primaries Hitting the Sieve Surface and then Showering into a Sieve (100mm) Hole (06mm Diameter) and Hit the Main Detector", 1000, 650, 1200);
...
//---Draw and Save Histograms---
  ...
  auto titleCleanPass = new TPaveLabel(0.0, 0.9, 1.0, 1.0, "Primaries that Hit the Main Detector Rings for a 100mm Full Tungsten Sieve with 06mm Diameter Holes", "brNDC");
  titleCleanPass -> Draw();
  ...
  cleanpass -> SaveAs("images/PTResults/CP_06Hole_Analysis_Sieve_100.png");
