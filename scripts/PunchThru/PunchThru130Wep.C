...
void PunchThru()
{
  ...
  T->Add("rootfilesPT/WSieveC12_ep_100k_130mm0.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_130mm1.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_130mm2.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_130mm3.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_130mm4.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_130mm5.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_130mm6.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_130mm7.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_130mm8.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_130mm9.root");
