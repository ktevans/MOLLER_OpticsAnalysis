...
void PowerDep()
{
  ...
  T->Add("rootfilesPT/blocker_beamC12_DS_1mm_0_v2.root");
//  T->Add("rootfilesPT/blocker_beamC12_DS_1mm_1_v2.root");
//  T->Add("rootfilesPT/blocker_beamC12_DS_1mm_2_v2.root");
//  T->Add("rootfilesPT/blocker_beamC12_DS_1mm_3_v2.root");
//  T->Add("rootfilesPT/blocker_beamC12_DS_1mm_4_v2.root");
  T->Add("rootfilesPT/blocker_beamC12_DS_1mm_5_v2.root");
//  T->Add("rootfilesPT/blocker_beamC12_DS_1mm_6_v2.root");
//  T->Add("rootfilesPT/blocker_beamC12_DS_1mm_7_v2.root");
//  T->Add("rootfilesPT/blocker_beamC12_DS_1mm_8_v2.root");
//  T->Add("rootfilesPT/blocker_beamC12_DS_1mm_9_v2.root");
  T->Add("rootfilesPT/blocker_beamC12_DS_1mm_10_v2.root");
//  T->Add("rootfilesPT/blocker_beamC12_DS_1mm_11_v2.root");
//  T->Add("rootfilesPT/blocker_beamC12_DS_1mm_12_v2.root");
//  T->Add("rootfilesPT/blocker_beamC12_DS_1mm_13_v2.root");
//  T->Add("rootfilesPT/blocker_beamC12_DS_1mm_14_v2.root");
  T->Add("rootfilesPT/blocker_beamC12_DS_1mm_15_v2.root");
//  T->Add("rootfilesPT/blocker_beamC12_DS_1mm_16_v2.root");
//  T->Add("rootfilesPT/blocker_beamC12_DS_1mm_17_v2.root");
//  T->Add("rootfilesPT/blocker_beamC12_DS_1mm_18_v2.root");
//  T->Add("rootfilesPT/blocker_beamC12_DS_1mm_19_v2.root");
...
//----------------------------------------------------------------------------
  ...
  TH1F *edep_blocker = new TH1F("edep_blocker","Sum of Energy Deposition on the Blocker for a 90mm Blocker with 1mm Inner Bore Radius and an Downstream C12 Target", 100, 0, 11000);
  edep_blocker -> GetXaxis() -> SetTitle("Energy Deposited on Detector [MeV]");

//----------------------------------------------------------------------------

  T -> Project("edep_blocker", "sum.edep", Form("%g*sum.edep*(sum.det==1000)", scale));
...
//Draw and save the histograms
  ...
  blocker -> SaveAs("images/PowerDep_Det1000_All_90mmblocker_DS_1mm_v2.png");
