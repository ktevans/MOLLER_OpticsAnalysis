...
;
  TH2F *us_sieve_virt = new TH2F("us_sieve_virt","Upstream W Sieve (1mm) Virtual Detector Electron and Positron Hits Greater than 10MeV for ep Scattering with C12 Target", 7000, -150, 150, 7000, -150, 150);
  us_sieve_virt -> GetXaxis() -> SetTitle("x Position of Hits [mm]");
  us_sieve_virt -> GetYaxis() -> SetTitle("y Position of Hits [mm]");

  TH2F *ds_sieve_virt = new TH2F("ds_sieve_virt","Downstream W Sieve (1mm) Virtual Detector Electron and Positron Hits Greater than 10MeV for ep Scattering with C12 Target", 7000, -150, 150, 7000, -150, 150);
  ds_sieve_virt -> GetXaxis() -> SetTitle("x Position of Hits [mm]");
  ds_sieve_virt -> GetYaxis() -> SetTitle("y Position of Hits [mm]");

  TH2F *punch_thru_main = new TH2F("punch_thru_main","Electrons and Positrons Greater than 10MeV that Punched Through the W Sieve (1mm) and Hit the Main Detector for ep Scattering with C12 Target", 1000, -1000, 1000, 1000, -1000, 1000);
  punch_thru_main -> GetXaxis() -> SetTitle("x Position of Hits [mm]");
  punch_thru_main -> GetYaxis() -> SetTitle("y Position of Hits [mm]");

  TH2F *part_energy = new TH2F("part_energy","Electron and Positron Energies Greater than 10MeV that Punched Through the W  Sieve (1mm) for ep Scattering with C12 Target", 1000, 0, 500, 1000, 30, 115);
  ...
  //TH2F *col2 = new TH2F("col2","Electrons and Positrons Greater than 10MeV that Punch Through the W Sieve (1mm) and Make it Past Collimator 2 for ep Scattering with C12 Target", 1000, -200, 200, 1000, -200, 200);
  //col2 -> GetXaxis() -> SetTitle("x Position of Hits [mm]");
  //col2 -> GetYaxis() -> SetTitle("y Position of Hits [mm]");

  TH1F *radial_main = new TH1F("radial_main","Electrons and Positrons Greater than 10MeV that Punch Through the W Sieve (1mm) and Hit the Main Detector",1000,500,1300);
...
//--------------------------------------------------------------------------------
  ...
  virt -> SaveAs("images/Punch_Thru_US_DS_WSieve_1mm_10MeV.png");
