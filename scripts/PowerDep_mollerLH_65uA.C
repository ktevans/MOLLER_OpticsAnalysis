...
void PowerDep()
{
  ...
  T->Add("rootfilesPT/moller65uA_sieve_0.root");
  T->Add("rootfilesPT/moller65uA_sieve_1.root");
  T->Add("rootfilesPT/moller65uA_sieve_2.root");
//  T->Add("rootfilesPT/moller65uA_sieve_3.root");
//  T->Add("rootfilesPT/moller65uA_sieve_4.root");
  T->Add("rootfilesPT/moller65uA_sieve_5.root");
  T->Add("rootfilesPT/moller65uA_sieve_6.root");
  T->Add("rootfilesPT/moller65uA_sieve_7.root");
//  T->Add("rootfilesPT/moller65uA_sieve_8.root");
//  T->Add("rootfilesPT/moller65uA_sieve_9.root");
  T->Add("rootfilesPT/moller65uA_sieve_10.root");
  T->Add("rootfilesPT/moller65uA_sieve_11.root");
  T->Add("rootfilesPT/moller65uA_sieve_12.root");
//  T->Add("rootfilesPT/moller65uA_sieve_13.root");
//  T->Add("rootfilesPT/moller65uA_sieve_14.root");
  T->Add("rootfilesPT/moller65uA_sieve_15.root");
  T->Add("rootfilesPT/moller65uA_sieve_16.root");
  T->Add("rootfilesPT/moller65uA_sieve_17.root");
//  T->Add("rootfilesPT/moller65uA_sieve_18.root");
//  T->Add("rootfilesPT/moller65uA_sieve_19.root");
...
//Draw and save the histograms
  ...
  blocker -> SaveAs("images/PowerDep_Det1000_All_90mmblocker_mollerLH_65uA.png");
