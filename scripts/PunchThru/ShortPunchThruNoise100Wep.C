...
#include <TF1.h>
void ShortPunchThruNoise100Wep()
{
...
//Define Histograms that we will fill later
  ...
  TH1F *radial_main_holes = new TH1F("radial_main_holes","Particles that Pass Through the Sieve Holes (100mm) and Hit the Main Detector", 1000, 650, 1200);
