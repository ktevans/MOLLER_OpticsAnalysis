...
void NewPunchThru70Wep()
{
  ...
  T->Add("rootfilesPT/WSieveC12_ep_100k_70mm0.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_70mm1.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_70mm2.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_70mm3.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_70mm4.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_70mm5.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_70mm6.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_70mm7.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_70mm8.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_70mm9.root");
...
//Define Histograms that we will fill later
  ...
  TH2F *punch_thru_main = new TH2F("punch_thru_main","Charged Particles that Punched Through the Sieve (70mm) and Hit the Main Detector for ep Scattering with Thin Carbon Target", 1000, -1200, 1200, 1000, -1200, 1200);
  ...
  TH1F *radial_main = new TH1F("radial_main","Charged Particles that Punch Through the Sieve (70mm) and Hit the Main Detector", 1000, 650, 1200);
  ...
  TH2F *main_holes = new TH2F("main_holes","Charged Particles that Pass Through the Sieve Holes (70mm) and Hit the Main Detector for ep Scattering with Thin Carbon Target", 1000, -1200, 1200, 1000, -1200, 1200);
  ...
  TH1F *radial_main_holes = new TH1F("radial_main_holes","Charged Particles that Pass Through the Sieve Holes (70mm) and Hit the Main Detector", 1000, 650, 1200);
  radial_main_holes -> GetXaxis() -> SetTitle("r Position of Hits [mm]");

  //2D histogram for electrons that make it to the main detector on the rings (xy plot)
  TH2F *main_all = new TH2F("main_all","All Charged Particles that Hit the Main Detector for ep Scattering with Thin Carbon Target and a 70mm Sieve", 1000, -1200, 1200, 1000, -1200, 1200);
  main_all -> GetXaxis() -> SetTitle("x Position of Hits [mm]");
  main_all -> GetYaxis() -> SetTitle("y Position of Hits [mm]");

  //1D histogram for electrons that make it to the main detector on the rings (r plot)
  TH1F *radial_main_all = new TH1F("radial_main_all","All Charged Particles that Hit the Main Detector for ep Scattering with Thin Carbon Target and a 70mm Sieve", 1000, 650, 1200);
...
//Draw and save the histograms
  ...
  virt -> SaveAs("images/NewPT/Punch_Thru_US_DS_WSieve_70.png");
  ...
  //Save the canvas as an image in the director "remoll/images/PT/"
  main -> SaveAs("images/NewPT/Punch_Thru_Main_WSieve_70.png");
  ...
  //Save the canvas as an image in the director "remoll/images/PT/"
  main_for_all -> SaveAs("images/NewPT/Punch_Thru_Main_All_WSieve_70.png");
  ...
  //Save the canvas as an image in the director "remoll/images/PT/"
  main_for_holes -> SaveAs("images/NewPT/Punch_Thru_Main_Holes_WSieve_70.png");
