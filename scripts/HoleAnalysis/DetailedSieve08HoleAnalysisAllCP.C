...
void DetailedSieve08HoleAnalysisAllCP()
{
...
//---Define Histograms---
  ...
  TH1F *radial_clean_pass = new TH1F("radial_clean_pass","All Charged Particles that Hit the Main Detector Ring 2 (08mm Hole Diameter)", 1000, 710, 760);
...
//---Separate the Histograms---
  ...
  separate -> SaveAs("images/HA/Sieve_08Hole_Analysis__AllCP.png");
