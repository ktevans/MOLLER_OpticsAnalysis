...
void PunchThru()
{
  ...
  T->Add("rootfiles/sieveC12_ep_100k_80mm.root");
  T->Add("rootfiles/sieveC12_ep_100k_80mm1.root");
  T->Add("rootfiles/sieveC12_ep_100k_80mm2.root");
  T->Add("rootfiles/sieveC12_ep_100k_80mm3.root");
  T->Add("rootfiles/sieveC12_ep_100k_80mm4.root");
  T->Add("rootfiles/sieveC12_ep_100k_80mm5.root");
  T->Add("rootfiles/sieveC12_ep_100k_80mm6.root");
  T->Add("rootfiles/sieveC12_ep_100k_80mm7.root");
  T->Add("rootfiles/sieveC12_ep_100k_80mm8.root");
  T->Add("rootfiles/sieveC12_ep_100k_80mm9.root");
  ...
  TH2F *us_sieve_virt = new TH2F("us_sieve_virt","Upstream Sieve (80mm) Virtual Detector Electron and Positron Hits for ep Scattering with C12 Target", 7000, -150, 150, 7000, -150, 150);
  us_sieve_virt -> GetXaxis() -> SetTitle("x Position of Hits [mm]");
  us_sieve_virt -> GetYaxis() -> SetTitle("y Position of Hits [mm]");

  TH2F *ds_sieve_virt = new TH2F("ds_sieve_virt","Downstream Sieve (80mm) Virtual Detector Electron and Positron Hits for ep Scattering with C12 Target", 7000, -150, 150, 7000, -150, 150);
  ds_sieve_virt -> GetXaxis() -> SetTitle("x Position of Hits [mm]");
  ds_sieve_virt -> GetYaxis() -> SetTitle("y Position of Hits [mm]");

  TH2F *punch_thru_main = new TH2F("punch_thru_main","Electrons and Positrons that Punched Through the Sieve (80mm) and Hit the Main Detector for ep Scattering with C12 Target", 1000, -1000, 1000, 1000, -1000, 1000);
  punch_thru_main -> GetXaxis() -> SetTitle("x Position of Hits [mm]");
  punch_thru_main -> GetYaxis() -> SetTitle("y Position of Hits [mm]");

  TH2F *part_energy = new TH2F("part_energy","Electron and Positron Energies that Punched Through the Sieve (80mm) for ep Scattering with C12 Target", 1000, 0, 500, 1000, 0, 150);
  ...
  //TH2F *col2 = new TH2F("col2","Electrons and Positrons that Punch Through the Sieve (80mm) and Make it Past Collimator 2 for ep Scattering with C12 Target", 1000, -200, 200, 1000, -200, 200);
  //col2 -> GetXaxis() -> SetTitle("x Position of Hits [mm]");
  //col2 -> GetYaxis() -> SetTitle("y Position of Hits [mm]");

  TH1F *radial_main = new TH1F("radial_main","Electrons and Positrons that Punch Through the Sieve (80mm) and Hit the Main Detector",1000,500,1300);
...
//--------------------------------------------------------------------------------
  ...
  virt -> SaveAs("images/Punch_Thru_US_DS_Sieve_80.png");
  ...
  main2 -> SaveAs("images/Punch_Thru_Main_80.png");

  TCanvas *energy = new TCanvas("energy","Electron and Positron Energies that Punch Through the Sieve", 600, 600, 600, 600);

  part_energy -> Draw();
  energy -> SaveAs("images/Punch_Thru_Energy_80.png");
