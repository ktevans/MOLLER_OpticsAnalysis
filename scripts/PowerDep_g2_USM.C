...
void PowerDep()
{
  ...
  T->Add("rootfilesPT/blocker_beamC12_USM_g2_0.root");
  T->Add("rootfilesPT/blocker_beamC12_USM_g2_1.root");
  T->Add("rootfilesPT/blocker_beamC12_USM_g2_2.root");
  T->Add("rootfilesPT/blocker_beamC12_USM_g2_3.root");
  T->Add("rootfilesPT/blocker_beamC12_USM_g2_4.root");
...
//----------------------------------------------------------------------------
  ...
  TH1F *edep_blocker = new TH1F("edep_blocker","Sum of Energy Deposition on the Blocker for a 90mm Blocker with 30.54mm Inner Bore Radius and USM Target Positions", 100, 0, 11000);
...
//Draw and save the histograms
  ...
  blocker -> SaveAs("images/PowerDep_Det1000_All_90mmblocker_g2_USM.png");
