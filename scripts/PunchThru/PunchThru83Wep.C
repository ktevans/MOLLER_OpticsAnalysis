...
void PunchThru()
{
  ...
  T->Add("rootfilesPT/WSieveC12_ep_100k_83mm0.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_83mm1.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_83mm2.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_83mm3.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_83mm4.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_83mm5.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_83mm6.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_83mm7.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_83mm8.root");
//  T->Add("rootfilesPT/WSieveC12_ep_100k_83mm9.root");
...
//--------------------------------------------------------------------------------
  ...
  virt -> SaveAs("images/PT/Punch_Thru_US_DS_WSieve_83.png");
