...
echo 'gROOT->LoadMacro("scripts/SurfaceAnalysisInnerBore.C"); Analysis("blocker", "g2"); gSystem->Exit(0);' | build/reroot -b -l

echo 'gROOT->LoadMacro("scripts/SurfaceAnalysisInnerBore.C"); Analysis("sieve", "g1"); gSystem->Exit(0);' | build/reroot -b -l

echo 'gROOT->LoadMacro("scripts/SurfaceAnalysisInnerBore.C"); Analysis("sieve", "g2"); gSystem->Exit(0);' | build/reroot -b -l
