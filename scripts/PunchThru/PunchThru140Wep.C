...
void PunchThru()
{
  ...
  T->Add("rootfilesPT/WSieveC12_ep_100k_140mm0.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_140mm1.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_140mm2.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_140mm3.root");
//  T->Add("rootfilesPT/WSieveC12_ep_100k_140mm4.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_140mm5.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_140mm6.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_140mm7.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_140mm8.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_140mm9.root");
...
//--------------------------------------------------------------------------------
  ...
  virt -> SaveAs("images/PT/Punch_Thru_US_DS_WSieve_140.png");
