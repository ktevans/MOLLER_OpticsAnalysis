...
void PunchThru()
{
  ...
  T->Add("rootfilesPT/WSieveC12_ep_100k_81mm0.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_81mm1.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_81mm2.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_81mm3.root");
//  T->Add("rootfilesPT/WSieveC12_ep_100k_81mm4.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_81mm5.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_81mm6.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_81mm7.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_81mm8.root");
  T->Add("rootfilesPT/WSieveC12_ep_100k_81mm9.root");
...
//--------------------------------------------------------------------------------
  ...
  virt -> SaveAs("images/PT/Punch_Thru_US_DS_WSieve_81.png");
