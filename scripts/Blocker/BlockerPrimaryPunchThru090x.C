...
#include <TF1.h>
void BlockerPrimaryPunchThru090x()
{
...
//----------------------------------------------------------------------------
  ...
  TH2F *us_Blocker_virt = new TH2F("us_Blocker_virt","Upstream Blocker (090mm) Virtual Detector Primary Hits", 100, -150, 150, 100, -150, 150);
  ...
  TH2F *ds_Blocker_virt = new TH2F("ds_Blocker_virt","Downstream Blocker (090mm) Virtual Detector Primary Hits", 100, -150, 150, 100, -150, 150);
  ...
  TH1F *radial_main = new TH1F("radial_main","Energies of Primaries that Exited the Downstream Blocker (090mm) Surface and Hit the Main Detector", 50, 0, 1500);
  ...
  TH2F *punch_thru_xy_main = new TH2F("punch_thru_xy_main","Primaries that Exited the Downstream Blocker (090mm) Surface and Hit the Main Detector", 100, -1200, 1200, 100, -1200, 1200);
  ...
  TH1F *radial_main_all = new TH1F("radial_main_all","Energies of All Primaries that Hit the Main Detector for a 090mm Blocker", 50, 0, 1500);
  ...
  TH2F *xy_main_all = new TH2F("xy_main_all","All Primaries that Hit the Main Detector for a 090mm Blocker", 100, -1200, 1200, 100, -1200, 1200);
