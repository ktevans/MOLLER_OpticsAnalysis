...
void PowerDep()
{
  ...
  T->Add("rootfilesPT/blocker_beamC12_MDS_g3_0.root");
  T->Add("rootfilesPT/blocker_beamC12_MDS_g3_1.root");
  T->Add("rootfilesPT/blocker_beamC12_MDS_g3_2.root");
  T->Add("rootfilesPT/blocker_beamC12_MDS_g3_3.root");
  T->Add("rootfilesPT/blocker_beamC12_MDS_g3_4.root");
...
//----------------------------------------------------------------------------
  ...
  TH1F *edep_blocker = new TH1F("edep_blocker","Sum of Energy Deposition on the Blocker for a 90mm Blocker with 26mm Inner Bore Radius and MDS Target Positions", 100, 0, 11000);
...
//Draw and save the histograms
  ...
  blocker -> SaveAs("images/PowerDep_Det1000_All_90mmblocker_g3_MDS.png");
