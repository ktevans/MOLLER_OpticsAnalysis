...
#include <TF1.h>
void PunchThru95WepNoise()
{
  //Allow Tree to use the root files that you call
  TChain* T = new TChain("T");
  
  //Add files from the directory "rootfilesPT/", "95" is the sieve thickness in mm
  T->Add("rootfilesPT/BWSieveC12_ep_100k_95mm0.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_95mm1.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_95mm2.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_95mm3.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_95mm4.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_95mm5.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_95mm6.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_95mm7.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_95mm8.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_95mm9.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_95mm10.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_95mm11.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_95mm12.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_95mm13.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_95mm14.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_95mm15.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_95mm16.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_95mm17.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_95mm18.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_95mm19.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_95mm21.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_95mm22.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_95mm23.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_95mm24.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_95mm25.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_95mm26.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_95mm27.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_95mm28.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_95mm29.root");
...
//Define Histograms that we will fill later
  ...
  TH2F *us_sieve_virt = new TH2F("us_sieve_virt","Upstream Sieve (95mm) Virtual Detector Electron and Positron Hits for ep Scattering with Thin Carbon Target", 7000, -150, 150, 7000, -150, 150);
  ...
  TH2F *ds_sieve_virt = new TH2F("ds_sieve_virt","Downstream Sieve (95mm) Virtual Detector Electron and Positron Hits for ep Scattering with Thin Carbon Target", 7000, -150, 150, 7000, -150, 150);
  ...
  TH2F *punch_thru_main = new TH2F("punch_thru_main","Electrons and Positrons that Punched Through the Sieve (95mm) and Hit the Main Detector for ep Scattering with Thin Carbon Target", 1000, -1200, 1200, 1000, -1200, 1200);
  ...
  TH1F *radial_main = new TH1F("radial_main","Electrons and Positrons that Punch Through the Sieve (95mm) and Hit the Main Detector", 1000, 650, 1200);
  ...
  TH2F *main_holes = new TH2F("main_holes","Electrons and Positrons that Pass Through the Sieve Holes (95mm) and Hit the Main Detector for ep Scattering with Thin Carbon Target", 1000, -1200, 1200, 1000, -1200, 1200);
  ...
  TH1F *radial_main_holes = new TH1F("radial_main_holes","Particles that Pass Through the Sieve Holes (95mm) and Hit the Main Detector", 1000, 650, 1200);
  ...
  TH2F *part_energy = new TH2F("part_energy","Electron and Positron Energies that Punched Through the Sieve (95mm) for ep Scattering with Thin Carbon Target", 1000, 0, 500, 1000, 0, 150);
  ...
  TH2F *part_high_energy = new TH2F("part_high_energy","Electron and Positron Energies that Punched Through the Sieve (95mm) for ep Scattering with Thin Carbon Target", 1000, 500, 1500, 1000, 0, 150);
...
//Draw and save the histograms
  ...
  virt -> SaveAs("images/PT/Punch_Thru_US_DS_WSieve_95.png");
  ...
  //Save the canvas as an image in the director "remoll/images/PT/"
  main -> SaveAs("images/PT/Punch_Thru_Main_WSieve_95.png");
  ...
  //Save the canvas as an image in the director "remoll/images/PT/"
  main_all -> SaveAs("images/PT/Punch_Thru_Main_Holes_WSieve_95.png");
  ...
  //Save the canvas as an image in the director "remoll/images/PT/"
  energy -> SaveAs("images/PT/Punch_Thru_Energy_WSieve_95.png");
