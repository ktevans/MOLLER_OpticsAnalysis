...
void DetailedSieve1HoleAnalysis()
{
...
//---Set up Chain and Tree---
  ...
  T->Add("rootfiles/WSieveC12_ep_100k_1mm.root");
  T->Add("rootfiles/WSieveC12_ep_100k_1mm1.root");
  T->Add("rootfiles/WSieveC12_ep_100k_1mm2.root");
  T->Add("rootfiles/WSieveC12_ep_100k_1mm3.root");
  T->Add("rootfiles/WSieveC12_ep_100k_1mm4.root");
  T->Add("rootfiles/WSieveC12_ep_100k_1mm5.root");
  T->Add("rootfiles/WSieveC12_ep_100k_1mm6.root");
  T->Add("rootfiles/WSieveC12_ep_100k_1mm7.root");
  T->Add("rootfiles/WSieveC12_ep_100k_1mm8.root");
  T->Add("rootfiles/WSieveC12_ep_100k_1mm9.root");
...
//---Define Histograms---
  ...
  TH1F *radial_clean_pass_1 = new TH1F("radial_clean_pass_1","Primaries that Pass Through Sieve (1mm) Hole 1 and Hit the Main Detector", 1000, 400, 1200);
  ...
  TH1F *radial_clean_pass_2 = new TH1F("radial_clean_pass_2","Primaries that Pass Through Sieve (1mm) Hole 2 and Hit the Main Detector", 1000, 400, 1200);
  ...
  TH1F *radial_clean_pass_3 = new TH1F("radial_clean_pass_3","Primaries that Pass Through Sieve (1mm) Hole 3 and Hit the Main Detector", 1000, 400, 1200);
  ...
  TH1F *radial_hole_shower = new TH1F("radial_hole_shower","Charged Particles that Result from Primaries Hitting a Sieve Hole and then Showering Through Sieve (10mm) and Hit the Main Detector", 1000, 400, 1200);
  ...
  TH1F *radial_hit_shower = new TH1F("radial_hit_shower","Charged Particles that Result from Primaries Hitting the Sieve Surface and then Showering into a Sieve (1mm) Hole and Hit the Main Detector", 1000, 400, 1200);
  ...
  TH1F *radial_punch_through = new TH1F("radial_punch_through","Primaries that Hit the Sieve (1mm) Surface and Punch Through into One of the Holes and then Hit the Main Detector", 1000, 400, 1200);
...
//----------------------------------------------------------------------------
  ...
  for (size_t iev = 0; iev < T->GetEntries(); iev++)
  {
    ...
    for (size_t ihit = 0; ihit < hits->size(); ihit++)
    {
      ...
      if(hit.trid == 1 && hit.det == 1001 && abs(hit.z - 624.5) < 0.1 && hit.pz >= 0)
      {
        in_hole_1 = true;
      }

      if(hit.trid == 1 && hit.det == 1002 && abs(hit.z - 624.5) < 0.1 && hit.pz >= 0)
      {
        in_hole_2 = true;
      }

      if(hit.trid == 1 && hit.det == 1003 && abs(hit.z - 624.5) < 0.1 && hit.pz >= 0)
      {
        in_hole_3 = true;
      }
      ...
      if(hit.trid == 1 && hit.det == 1001 && abs(hit.z - 625.5) < 0.1 && hit.pz <= 0)
      {
        prim_out_hole_1 = true;
      }

      if(hit.trid == 1 && hit.det == 1002 && abs(hit.z - 625.5) < 0.1 && hit.pz <= 0)
      {
        prim_out_hole_2 = true;
      }

      if(hit.trid == 1 && hit.det == 1003 && abs(hit.z - 625.5) < 0.1 && hit.pz <= 0)
      {
      ...
      if((hit.pid == 11 || hit.pid == -11) && hit.det == 1001 && abs(hit.z - 625.5) < 0.1 && hit.pz <= 0)
      {
        any_out_hole_1 = true;
      }

      if((hit.pid == 11 || hit.pid == -11) && hit.det == 1002 && abs(hit.z - 625.5) < 0.1 && hit.pz <= 0)
      {
        any_out_hole_2 = true;
      }

      if((hit.pid == 11 || hit.pid == -11) && hit.det == 1003 && abs(hit.z - 625.5) < 0.1 && hit.pz <= 0)
      {
        any_out_hole_3 = true;
      }
    ...
    for (size_t ihit = 0; ihit < hits->size(); ihit++)
    {
      ...
      if(hit.trid == 1 && hit.pz >= 0 && hit.det == 28 && hit.r>=400 && hit.r<=1200)
      {
      ...
      if((hit.pid == 11 || hit.pid == -11) && (hole_shower_1 || hole_shower_2 || hole_shower_3) && hit.pz >= 0 && hit.det == 28 && hit.r>=400 && hit.r<=1200)
      {
      ...
      if((hit.pid == 11 || hit.pid == -11) && (hit_shower_1 || hit_shower_2 || hit_shower_3) && hit.pz >= 0 && hit.det == 28 && hit.r>=400 && hit.r<=1200)
      {
      ...
      if(hit.trid == 1 && (hit_pt_1 || hit_pt_2 || hit_pt_3) && hit.pz >= 0 && hit.det == 28 && hit.r>=400 && hit.r<=1200)
      {
...
//---Clean Pass---
  ...
  cleanpass -> SaveAs("images/PTResults/Clean_Pass_Sieve_1.png");
...
//---Hole Showers---
  ...
  holeshower -> SaveAs("images/PTResults/Hole_Shower_Sieve_1.png");
...
//---Hit Showers---
  ...
  hitshower -> SaveAs("images/PTResults/Hit_Shower_Sieve_1.png");
...
//---True Punch-Through---
  ...
  truePT -> SaveAs("images/PTResults/True_Punch_Through_Sieve_1.png");
