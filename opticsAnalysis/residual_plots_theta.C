...
//------------------------------------------------------------------------------
  ...
  graphC->SaveAs("opticsAnalysis/opticsMatrix/ResidualPlots/theta/tg_th_vs_gem1_r_"+trgt+"_"+pass+"_"+hole_id+".pdf");
  ...
  gPad -> Modified();
  gPad -> Update();
  resid_can -> SaveAs("opticsAnalysis/opticsMatrix/ResidualPlots/theta/residuals_th_vs_gem1_r_"+trgt+"_"+pass+"_"+hole_id+".pdf");
  ...
  canvas_oned_resid -> SaveAs("opticsAnalysis/opticsMatrix/ResidualPlots/theta/1d_residuals_th_"+trgt+"_"+pass+"_"+hole_id+".pdf");
