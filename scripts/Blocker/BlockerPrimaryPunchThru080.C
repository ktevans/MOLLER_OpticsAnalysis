...
#include <TF1.h>
void BlockerPrimaryPunchThru080()
{
  //Allow Tree to use the root files that you call
  TChain* T = new TChain("T");

  //Add files from the directory "rootfilesPT/", "080" is the Blocker thickness in mm
  T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_080mm0.root");
  T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_080mm1.root");
  T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_080mm2.root");
  T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_080mm3.root");
  T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_080mm4.root");
  T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_080mm5.root");
  T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_080mm6.root");
  T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_080mm7.root");
  T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_080mm8.root");
  T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_080mm9.root");
/*
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_080mm10.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_080mm11.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_080mm12.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_080mm13.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_080mm14.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_080mm15.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_080mm16.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_080mm17.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_080mm18.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_080mm19.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_080mm20.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_080mm21.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_080mm22.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_080mm23.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_080mm24.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_080mm25.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_080mm26.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_080mm27.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_080mm28.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_080mm29.root");
*/
...
//----------------------------------------------------------------------------
  ...
  TH2F *us_Blocker_virt = new TH2F("us_Blocker_virt","Upstream Blocker (080mm) Virtual Detector Primaries Hits for ep Scattering with Thin Carbon Target", 7000, -150, 150, 7000, -150, 150);
  ...
  TH2F *ds_Blocker_virt = new TH2F("ds_Blocker_virt","Downstream Blocker (080mm) Virtual Detector Primaries Hits for ep Scattering with Thin Carbon Target", 7000, -150, 150, 7000, -150, 150);
  ...
  TH2F *radial_main = new TH2F("radial_main","Energies of Primaries that Punch Through the Blocker (080mm) and Hit the Main Detector", 1000, 650, 1200, 3000, 0, 1500);
  ...
  TH2F *punch_thru_xy_main = new TH2F("punch_thru_xy_main","Primaries that Punched Through the Blocker (080mm) and Hit the Main Detector for ep Scattering with Thin Carbon Target", 1000, -1200, 1200, 1000, -1200, 1200);
  ...
  TH2F *radial_main_all = new TH2F("radial_main_all","Energies of All Primaries that Hit the Main Detector for a 080mm Blocker", 1000, 650, 1200, 3000, 0, 1500);
  ...
  TH2F *xy_main_all = new TH2F("xy_main_all","All Primaries that Hit the Main Detector for a 080mm Blocker", 1000, -1200, 1200, 1000, -1200, 1200);
  ...
  for (size_t iev = 0; iev < T->GetEntries(); iev++)
  {
    ...
    for (size_t ihit = 0; ihit < hits->size(); ihit++)
    {
      remollGenericDetectorHit_t hit = hits->at(ihit);
        ...
        if (punch_thru && hit.det==28 && hit.r>=650 && hit.r<=1200 && (hit.trid==1 || hit.trid==2) && hit.pz>=0)
        {
        ...
        if (hit.det==28 && hit.r>=650 && hit.r<=1200 && hit.pz>=0&& (hit.trid==1 || hit.trid==2))
        {
...
//Draw and save the histograms
  ...
  virt -> SaveAs("images/Blocker/Primary_Punch_Thru_US_DS_WBlocker_080.png");
  ...
  //Save the canvas as an image in the director "remoll/images/Blocker/"
  main -> SaveAs("images/Blocker/Primary_Punch_Thru_Main_WBlocker_080.png");
  ...
  //Save the canvas as an image in the director "remoll/images/Blocker/"
  main_all_charged -> SaveAs("images/Blocker/Primary_Main_All_WBlocker_080.png");
