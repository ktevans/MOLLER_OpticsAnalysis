...
#include <TF1.h>
void BlockerPrimaryPunchThru030()
{
  //Allow Tree to use the root files that you call
  TChain* T = new TChain("T");

  //Add files from the directory "rootfilesPT/", "030" is the Blocker thickness in mm
  T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_030mm0.root");
  T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_030mm1.root");
  T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_030mm2.root");
  T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_030mm3.root");
  T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_030mm4.root");
  T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_030mm5.root");
  T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_030mm6.root");
  T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_030mm7.root");
  T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_030mm8.root");
  T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_030mm9.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_030mm10.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_030mm11.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_030mm12.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_030mm13.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_030mm14.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_030mm15.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_030mm16.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_030mm17.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_030mm18.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_030mm19.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_030mm20.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_030mm21.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_030mm22.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_030mm23.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_030mm24.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_030mm25.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_030mm26.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_030mm27.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_030mm28.root");
T->Add("rootfilesPT/blocker/WBlockerC12_ep_100k_030mm29.root");
...
//----------------------------------------------------------------------------
  ...
  TH2F *us_Blocker_virt = new TH2F("us_Blocker_virt","Upstream Blocker (030mm) Virtual Detector Primaries Hits for ep Scattering with Thin Carbon Target", 7000, -150, 150, 7000, -150, 150);
  ...
  TH2F *ds_Blocker_virt = new TH2F("ds_Blocker_virt","Downstream Blocker (030mm) Virtual Detector Primaries Hits for ep Scattering with Thin Carbon Target", 7000, -150, 150, 7000, -150, 150);
  ...
  TH2F *radial_main = new TH2F("radial_main","Energies of Primaries that Punch Through the Blocker (030mm) and Hit the Main Detector", 1000, 650, 1200, 3000, 0, 1500);
  ...
  TH2F *punch_thru_xy_main = new TH2F("punch_thru_xy_main","Primaries that Punched Through the Blocker (030mm) and Hit the Main Detector for ep Scattering with Thin Carbon Target", 1000, -1200, 1200, 1000, -1200, 1200);
  ...
  TH2F *radial_main_all = new TH2F("radial_main_all","Energies of All Primaries that Hit the Main Detector for a 030mm Blocker", 1000, 650, 1200, 3000, 0, 1500);
  ...
  TH2F *xy_main_all = new TH2F("xy_main_all","All Primaries that Hit the Main Detector for a 030mm Blocker", 1000, -1200, 1200, 1000, -1200, 1200);
...
//Draw and save the histograms
  ...
  virt -> SaveAs("images/Blocker/Primary_Punch_Thru_US_DS_WBlocker_030.png");
  ...
  //Save the canvas as an image in the director "remoll/images/Blocker/"
  main -> SaveAs("images/Blocker/Primary_Punch_Thru_Main_WBlocker_030.png");
  ...
  //Save the canvas as an image in the director "remoll/images/Blocker/"
  main_all_charged -> SaveAs("images/Blocker/Primary_Main_All_WBlocker_030.png");
