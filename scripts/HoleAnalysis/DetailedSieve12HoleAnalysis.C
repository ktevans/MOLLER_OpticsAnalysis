...
void DetailedSieve12HoleAnalysis()
{
...
//---Define Histograms---
  ...
  TH1F *radial_clean_pass = new TH1F("radial_clean_pass","Charged Particles that Pass Through Any of the Sieve (100mm) Holes (12mm Diameter) and Hit the Main Detector", 1000, 650, 1200);
  ...
  TH1F *radial_hole_shower = new TH1F("radial_hole_shower","Charged Particles that Result from Primaries Hitting a Sieve Hole (12mm Diameter) and then Showering Through Sieve (100mm) and Hit the Main Detector", 1000, 650, 1200);
  ...
  TH1F *radial_hit_shower = new TH1F("radial_hit_shower","Charged Particles that Result from Primaries Hitting the Sieve Surface and then Showering into a Sieve (100mm) Hole (12mm Diameter) and Hit the Main Detector", 1000, 650, 1200);
...
//---Draw and Save Histograms---
  ...
  auto titleCleanPass = new TPaveLabel(0.0, 0.9, 1.0, 1.0, "Primaries that Hit the Main Detector Rings for a 100mm Full Tungsten Sieve with 12mm Diameter Holes", "brNDC");
  titleCleanPass -> Draw();
  ...
  cleanpass -> SaveAs("images/PTResults/CP_12Hole_Analysis_Sieve_100.png");
