...
//--------------------------------------------------------------------------------
  ...
  virt -> SaveAs("images/PT/Punch_Thru_US_DS_WSieve_withHoles_80.png");
  ...
  main -> SaveAs("images/PT/Punch_Thru_Main_WSieve_withHoles_80.png");

  TCanvas *energy = new TCanvas("energy","Electron and Positron Energies that Punch Through the Sieve", 400, 400, 600, 600);

  part_energy -> Draw();
  energy -> SaveAs("images/PT/Punch_Thru_Energy_WSieve_withHoles_80.png");
