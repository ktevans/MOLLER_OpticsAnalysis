...
//   build/reroot
//   .L scripts/PrimaryAnalysis100mm12.C
//   PunchThru()
//
...
#include <TF1.h>
void MollerPrimaryAnalysis100mm12()
{
  ...
  T->Add("rootfiles/PrimAnalysis/moller_test_100k_100mm12.root");
...
//Draw and save the histograms
  ...
  main -> SaveAs("images/PrimAnalysis/moller_prim_main_WSieve_100_12.png");

  TCanvas *us = new TCanvas("us","Particles Hitting the Upstream Detector", 1000, 1000, 1000, 1000);

  prim_us -> Draw();

  us -> SaveAs("images/PrimAnalysis/moller_prim_us_WSieve_100_12.png");

  TCanvas *ds = new TCanvas("ds","Particles Hitting the Downstream Detector", 1000, 1000, 1000, 1000);

  prim_ds -> Draw();

  ds -> SaveAs("images/PrimAnalysis/moller_prim_ds_WSieve_100_12.png");
