...
void PunchThru()
{
  ...
  T->Add("rootfiles/WSieveC12_ep_100k_60mm.root");
  T->Add("rootfiles/WSieveC12_ep_100k_60mm1.root");
  T->Add("rootfiles/WSieveC12_ep_100k_60mm2.root");
  T->Add("rootfiles/WSieveC12_ep_100k_60mm3.root");
  T->Add("rootfiles/WSieveC12_ep_100k_60mm4.root");
  T->Add("rootfiles/WSieveC12_ep_100k_60mm5.root");
  T->Add("rootfiles/WSieveC12_ep_100k_60mm6.root");
  T->Add("rootfiles/WSieveC12_ep_100k_60mm7.root");
  T->Add("rootfiles/WSieveC12_ep_100k_60mm8.root");
  T->Add("rootfiles/WSieveC12_ep_100k_60mm9.root");
...
//--------------------------------------------------------------------------------
  ...
  virt -> SaveAs("images/Punch_Thru_US_DS_WSieve_60mm_10MeV.png");
