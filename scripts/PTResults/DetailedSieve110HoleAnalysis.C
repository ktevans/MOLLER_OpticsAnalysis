...
//   build/reroot
//   .L scripts/DetailedSieve110HoleAnalysis1.C
//   DetailedSieve110HoleAnalysis()
//  Or use:
//   build/reroot -l -q -b 'DetailedSieve110HoleAnalysis1.C()'
//
...
//110 is the sieve thickness in mm
void DetailedSieve110HoleAnalysis()
{
...
//---Set up Chain and Tree---
  ...
  //Add files from the directory "rootfilesPT/", "110" is the sieve thickness in mm
  T->Add("rootfilesPT/BWSieveC12_ep_100k_110mm0.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_110mm1.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_110mm2.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_110mm3.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_110mm4.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_110mm5.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_110mm6.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_110mm7.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_110mm8.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_110mm9.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_110mm10.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_110mm11.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_110mm12.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_110mm13.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_110mm14.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_110mm15.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_110mm16.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_110mm17.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_110mm18.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_110mm19.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_110mm20.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_110mm21.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_110mm22.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_110mm23.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_110mm24.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_110mm25.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_110mm26.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_110mm27.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_110mm28.root");
  T->Add("rootfilesPT/BWSieveC12_ep_100k_110mm29.root");
...
//---Define Histograms---
  ...
  TH1F *radial_clean_pass = new TH1F("radial_clean_pass","Charged Particles that Cleanly Pass Through Any of the Sieve (110mm) Holes and Hit the Main Detector", 1000, 650, 1200);
  ...
  TH1F *radial_hole_shower = new TH1F("radial_hole_shower","Charged Particles that Result from Primaries Hitting a Sieve Hole and then Showering Through Sieve (110mm) and Hit the Main Detector", 1000, 650, 1200);
  ...
  TH1F *radial_hit_shower = new TH1F("radial_hit_shower","Charged Particles that Result from Primaries Hitting the Sieve Surface and then Showering into a Sieve (110mm) Hole and Hit the Main Detector", 1000, 650, 1200);
...
//----------------------------------------------------------------------------
  ...
  for (size_t iev = 0; iev < T->GetEntries(); iev++)
  {
    ...
    for (size_t ihit = 0; ihit < hits->size(); ihit++)
    {
      ...
      if((hit.trid == 1 || hit.trid == 2 || hit.pid == 11 || hit.pid == -11) && (hit.det == 1001 || hit.det == 1002 || hit.det == 1003) && abs(hit.z - z_i) < 0.1 && hit.pz >= 0)
      {
        in_hole = true;
      }
...
//---Draw and Save Histograms---
  ...
  auto titleCleanPass = new TPaveLabel(0.0, 0.9, 1.0, 1.0, "Primaries that Hit the Main Detector Rings for a 110mm Full Tungsten Sieve", "brNDC");
  titleCleanPass -> Draw();
  ...
  cleanpass -> SaveAs("images/PTResults/CP_Hole_Analysis_Sieve_110.png");
  ...
  separate -> SaveAs("images/PTResults/CP_Hole_Analysis_Sieve_110_Separate.png");

}//end DetailedSieve110HoleAnalysis()
